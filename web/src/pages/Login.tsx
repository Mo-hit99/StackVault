    ...
    >
      <div className="glass-panel w-full max-w-md p-10 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 mt-2 font-medium">Continue your versioning journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              ...
              <Link to="#" className="text-xs font-bold text-brand-400 hover:text-brand-300">Forgot?</Link>
            </div>
            <div className="relative group">
        ...
        <div className="mt-10 pt-8 border-t border-white/5 text-center">
          <p className="text-sm text-slate-500 font-medium">
            New to StackVault? <Link to="/register" className="text-brand-400 hover:text-brand-300 font-bold ml-1">Create an account</Link>
          </p>
        </div>
      </div>
    </motion.div>
